  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-4 py-12">
      <div className="mb-8 text-center">
        ...
        <h1 className="mt-6 text-2xl font-bold tracking-tight text-slate-900">Set a new password</h1>
      </div>
      ...
      >
        ...
        <div className="relative mt-1.5">
          <input
            ...
            className="w-full rounded-xl border border-slate-200 px-3 py-2.5 pr-11 text-sm outline-none ring-[var(--accent)] focus:ring-2"
          />
          <button
            type="button"
