    ...
    return (
      <div className="min-h-screen bg-[#f7f7f7]">
        ...
        <div className="mx-auto max-w-lg px-6 py-20 text-center">
          <p className="text-lg font-semibold text-slate-800">Plan not found</p>
    ...
    <div className="min-h-screen bg-[#f7f7f7] text-slate-800">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        <div className="mb-6 flex flex-wrap gap-3">
          <Link
            href={readerHref}
            className="inline-flex items-center gap-2 rounded-full bg-[var(--accent)] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[var(--accent)]/90"
          >
        ...
        <h2 className="mb-4 text-lg font-bold text-slate-900">Your daily lessons</h2>
          ...
          {days.map((day) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex w-full items-center gap-4 rounded-2xl border bg-white px-4 py-4 text-left transition',
                  done ? 'border-[var(--accent)]/40' : 'border-slate-200 hover:border-[var(--accent)]/40'
                )}
              >
                {done ? (
