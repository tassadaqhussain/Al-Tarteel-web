    ...
    <>
      <div className="flex min-w-0 flex-nowrap items-center justify-end gap-1.5 sm:gap-2">
        ...
        <button
          ...
          className="inline-flex h-9 items-center gap-1.5 rounded-[4px] border border-slate-200 bg-white px-2.5 text-xs font-semibold text-slate-700 hover:border-[var(--accent)] hover:text-[var(--accent)] sm:px-3 sm:text-sm"
        ...
        <div
          className="flex shrink-0 flex-nowrap justify-end rounded-[4px] bg-slate-100 p-1"
          role="tablist"
          ...
          {MODES.map(({ id, label, Icon }) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'inline-flex items-center gap-1.5 rounded-[3px] px-2 py-1.5 text-xs font-medium transition-colors sm:px-3',
                  active
        ...
        <button
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[4px] text-[var(--recite-highlight)] hover:bg-[var(--recite-highlight)]/10"
