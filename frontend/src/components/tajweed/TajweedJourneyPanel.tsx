    ...
    <section className="space-y-4">
      {personal && (
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 flex flex-wrap items-end justify-between gap-3">
            <div>
              <p className="text-lg font-bold text-slate-900">Continue Tajweed</p>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            <h2 className="text-lg font-bold text-slate-900">Tajweed Journey</h2>
            ...
            return (
              <li key={lesson.slug}>
                <Link
                  ...
                  className="flex items-center gap-3 rounded-xl px-1 py-1.5 hover:bg-slate-50"
                >
                  ...
                  <span
                    className={cn(
                      ...
                      mastery === 'reviewed' ? 'text-emerald-700' : 'text-slate-500',
                    )}
                  >
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <dl className="mt-4 grid grid-cols-2 gap-3 text-sm">
            <div>
              ...
              <dd className="font-semibold text-slate-900">{week.lessonsCompleted}</dd>
            </div>
            <div>
              <dt className="text-slate-500">Rules reviewed</dt>
              <dd className="font-semibold text-slate-900">{week.rulesReviewed}</dd>
            </div>
            <div>
              <dt className="text-slate-500">Practice visits</dt>
              <dd className="font-semibold text-slate-900">{week.examplesPracticed}</dd>
            </div>
            <div>
              <dt className="text-slate-500">Learning days</dt>
              <dd className="font-semibold text-slate-900">{week.learningDays}</dd>
            </div>
          </dl>
          {week.strongest && (
            <p className="mt-3 text-sm text-slate-600">
